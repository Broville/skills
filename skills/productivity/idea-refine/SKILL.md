...
Refines raw ideas into sharp, actionable concepts through structured divergent and convergent thinking. Use when an...
...
- Generating 20 shallow variations instead of 5-8 strong ones.
- Skipping "who is this for."
- Saving an artifact before the user confirms direction.

## Verification

- [ ] A one-page artifact captures problem, direction, assumptions, MVP scope, and "not doing" list.
- [ ] The user explicitly confirmed the chosen direction.
- [ ] Hidden assumptions are named with validation strategies.
