...
Extracts what the user actually wants instead of what they think they should want. Achieves this through...
...
- Phrases like "I should probably…", "I think the agent is supposed to…", "good engineering practice says…"
...
| "the agent will figure it out as I build" | Switching costs after code exists are 10x what they are now. Discovery during implementation is rework. |
...
| "If I attach my guess, the agent is leading them" | Leading is the point. Reacting is faster than generating from scratch. The risk is sycophancy, not leading; mitigate by being visibly willing to be wrong. |
...
- Asking three questions at once instead of one at a time.
- Accepting "whatever you think" as confirmation.
- Proceeding to implementation before the user explicitly says yes.

## Verification

- [ ] An explicit hypothesis with confidence was stated in the first turn.
- [ ] Questions were asked one at a time with a guess attached.
- [ ] The user confirmed the restate with an explicit yes before proceeding.
