...
# Mock the library entirely to avoid network and dependency issues
import types
...
def test_output_formats():
    ...
    assert envelope['transcript_plain'] == " [♪♪♪] ♪ We're no strangers to love ♪ ♪ You know the rules and so do I ♪"
