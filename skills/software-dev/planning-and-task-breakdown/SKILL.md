...
Breaks work into ordered tasks. Use when you have a spec or clear requirements and need to break work into...
...
|---|---|
| "the agent will figure it out as I go" | That's how you end up with a tangled mess and rework. 10 minutes of planning saves hours. |
...
- Creating horizontal slices that leave the system non-working for multiple tasks.
- Writing tasks too large to verify in a single session.
- Skipping dependency mapping before ordering tasks.

## Verification

- [ ] `tasks/plan.md` and `tasks/todo.md` exist and are readable.
- [ ] Every task has acceptance criteria and a verification step.
- [ ] Dependency order is clear and high-risk tasks are early.
