...
Optimizes application performance across frontend, backend, queries, and databases. Use when performance...
...
- Keeping a neutral change because it was already written.
- Bundling several optimizations into one un-attributable measurement.

## Verification

- [ ] Baseline and re-measurement numbers exist for the changed area.
- [ ] Core Web Vitals or target SLA is met.
- [ ] Tests still pass and no behavior was sacrificed for speed.
