...
Create diagrams and visualizations using Mermaid syntax. Use when generating flowcharts, sequence diagrams, class...
...
- Overloading a single diagram with every node.
- Using ambiguous node labels without a legend.
- Assuming the renderer supports every Mermaid feature equally.

## Verification

- [ ] The Mermaid block renders without syntax errors in the target viewer.
- [ ] Node labels and relationships are unambiguous.
- [ ] The diagram is saved or embedded in the intended documentation.
