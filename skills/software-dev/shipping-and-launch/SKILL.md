...
Prepares production launches. Use when preparing to deploy to production. Use when you need a pre-launch checklist,...
...
- Launching without a rollback plan or feature flag.
- Skipping post-deploy monitoring before increasing rollout percentage.
- Leaving feature flags in code after full rollout.

## Verification

- [ ] All pre-launch checklist items are complete.
- [ ] Feature flag is OFF at deploy time and rollout percentages are logged.
- [ ] Rollback command or procedure is documented and tested.
- [ ] Health checks, error rates, and latency are within thresholds 30 minutes after each rollout stage.
