...
Usage:
  ...
  python3 fetch_comments.py --pr 123 > pr_comments.json
  python3 fetch_comments.py --pr https://github.com/org/repo/pull/123 > pr_comments.json
"""
...
def _ensure_gh_authenticated() -> None:
    try:
        ...
        raise RuntimeError("gh auth status failed; run `gh auth login` to authenticate") from None
...
def gh_api_graphql(
    ...
    """
    Call `gh api graphql` using -F variables.
