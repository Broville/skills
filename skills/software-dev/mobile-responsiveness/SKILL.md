...
Build responsive, mobile-first web applications. Use when implementing responsive layouts, touch interactions,...
...
- Designing desktop-first and shrinking down.
- Hiding content on mobile instead of restructuring.
- Using fixed breakpoints without testing real devices.

## Verification

- [ ] Layouts adapt across 320px, 768px, 1024px, and 1280px viewports.
- [ ] Touch targets are at least 44×44 CSS pixels.
- [ ] No horizontal scroll or clipped content on small screens.
