...
description: Builds production-quality, accessible, responsive user-facing UIs. Use when building or modifying interfaces and page...
version: 1.0.0
author: Broville
license: MIT
platforms:
...
**Avoid prop drilling deeper than 3 levels.** If the agent is passing props through components that don't use them, introduce context or restructure the component tree.
