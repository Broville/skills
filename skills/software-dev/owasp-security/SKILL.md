...
- Returning verbose error stacks in production.

## Verification

- [ ] Input validation, parameterized queries, and secure headers are in place.
- [ ] Auth endpoints have rate limiting and short-lived tokens.
